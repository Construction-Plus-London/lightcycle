...
public abstract class ShazamLightCycleSupportDialogFragment extends DialogFragment
    ...
    private final ShazamSupportFragmentLightCycleDispatcher<DialogFragment> lifeCycleDispatcher;
    private boolean bound;

    public ShazamLightCycleSupportDialogFragment() {
        lifeCycleDispatcher = new ShazamSupportFragmentLightCycleDispatcher<>();
    }

    @Override
    public void bind(ShazamSupportFragmentLightCycle<DialogFragment> lifeCycleComponent) {
